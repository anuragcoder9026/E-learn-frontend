...
const Classroom = () => {
  ...
  useEffect(() => {
    ...
    axios.post("https://e-learn-backend.onrender.com/classes/getClassroom", {
        classCode: classCode
  ...
  useEffect(async () => {
    if (storeData.token){
      ...
      axios.post("https://e-learn-backend.onrender.com/classes/getReminders", {
        ...
        .then(async (res)=>{
          ...
          for (let reminder of res.data) {
            await axios.post("https://e-learn-backend.onrender.com/classes/getClassroom", {
  ...
  const deleteClass = () => {
    axios.delete("https://e-learn-backend.onrender.com/classes/deleteClassroom", {
