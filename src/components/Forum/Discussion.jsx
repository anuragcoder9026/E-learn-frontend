...
const Discussion = () => {
    ...
    const getDiscussion = async () => {
        setLoading(true);
        await axios.post("https://e-learn-backend.onrender.com/forum/getDiscussions",{
        ...
        if (fileInput) {
            ...
            uploadTask.on('state_changed', console.log, console.error, () => {
                storage.ref('forum').child(fileName).getDownloadURL()
                  .then(firebaseURL => {
                    return axios.post('https://e-learn-backend.onrender.com/forum/createDiscussion', {
            ...
            axios.post('https://e-learn-backend.onrender.com/forum/createDiscussion', {
                creatorEmail: userData.userEmail,
                creatorName: userData.userName,
                desc: discussionInput
            }, 
